/**
 * Types, data fetching hook, and utility hooks for Aircraft Interior Lighting dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Aircraft Interior Lighting Market"]);
  ...
  console.log("[Aircraft Interior Lighting parser] Parsed:", {
    years: years.length,
