/**
 * ============================================================
 * DASHBOARD CONFIGURATION — Aircraft Interior Lighting Market
 * ============================================================
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/2",
  title: "Global Aircraft Interior Lighting Market",
  ...
  routePath: "/dashboard/aircraft-interior-lighting",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-interiors",
    dashboardId: "aircraft-interior-lighting",
    dashboardName: "Aircraft Interior Lighting Market",
    purchased: true,
