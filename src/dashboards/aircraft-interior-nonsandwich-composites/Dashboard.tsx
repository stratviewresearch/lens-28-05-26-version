...
const AircraftInteriorNonSandwichCompositesDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.endUser, title: "Sales Channel" };
...
export default AircraftInteriorNonSandwichCompositesDashboard;
