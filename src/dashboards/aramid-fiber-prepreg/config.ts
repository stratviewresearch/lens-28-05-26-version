/**
 * DASHBOARD CONFIGURATION — Aramid Fiber Prepreg Market
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/33",
  ...
  catalog: {
    ...
    datasetId: "prepregs",
    dashboardId: "aramid-fiber-prepreg",
    dashboardName: "Aramid Fiber Prepreg Market",
    purchased: true,
    datasetName: "Prepreg",
  },
} as const;
