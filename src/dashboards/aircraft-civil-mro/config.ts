/**
 * DASHBOARD CONFIGURATION — Aircraft Civil MRO Market
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/40",
  title: "Aircraft Civil MRO Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025,
  useMillions: false, // values are in US$ Billion

  footerText: "Aircraft Civil MRO Market Research Report",
  ...
  routePath: "/dashboard/aircraft-civil-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "aircraft-civil-mro",
    dashboardName: "Aircraft Civil MRO Market",
    purchased: true,
