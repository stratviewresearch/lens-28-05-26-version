/**
 * Types, data fetching hook, and utility hooks for Aircraft Cabin Interiors dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Aircraft Cabin Interiors Market", "Aircraft Cabin Interior"]);
  ...
  console.log("[Cabin Interiors parser] Parsed:", {
    years: years.length,
