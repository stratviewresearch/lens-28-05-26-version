/**
 * Segment Detail Tab — self-contained for BMI Prepreg dashboard.
 * No Aircraft Type or Material Type in this market.
 * Cross-tabs: End Use by Region, Application by Region, Reinforcement by Region, Curing by Region.
 */
