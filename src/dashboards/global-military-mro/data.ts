...
const COUNTRIES = [
  "USA", "Canada", "Mexico", "Eastern Europe", "Western Europe",
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Global Military MRO Market", "Military MRO Market", "Aircraft MRO Market", "MRO Market"]);
