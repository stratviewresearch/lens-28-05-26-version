/**
 * DASHBOARD CONFIGURATION — Global Military MRO Market
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/43",
  title: "Global Military MRO Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025,
  useMillions: false, // values are in US$ Billion

  footerText: "Global Military MRO Market Research Report",
  ...
  routePath: "/dashboard/global-military-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "global-military-mro",
    dashboardName: "Global Military MRO Market",
    purchased: true,
