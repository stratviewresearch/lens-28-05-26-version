/**
 * Main Dashboard Page — Aircraft Interiors Prepreg Market
 */
...
import { ResinTypeTab } from "./ResinTypeTab";

const AircraftInteriorsPrepregDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.endUser, title: "Panel Type" };
...
export default AircraftInteriorsPrepregDashboard;
