/**
 * Market Overview Tab — self-contained for Aircraft Seats dashboard.
 */
...
export function MarketOverviewTab({ marketData, selectedYear, onNavigateToTab }: MarketOverviewTabProps) {
  ...
  const handleSliceClick = (segmentName: string, segmentData: YearlyData[], color: string, donutType: TabType) => {
    ...
    switch (donutType) {
      ...
      case "seatClass": relatedSegments = { title: "By Region", data: marketData.region }; break;
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <DistributionDonutsRow
          ...
          seatClassData={marketData.seatClass}
          componentData={marketData.component}
