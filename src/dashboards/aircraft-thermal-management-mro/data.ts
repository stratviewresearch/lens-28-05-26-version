/**
 * Types, data fetching hook, and utility hooks for Aircraft Thermal Management MRO dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Aircraft Thermal Management MRO", "Safety MRO", "MRO Market"]);
  ...
  console.log("[Aircraft Thermal Management MRO parser] Parsed:", {
    years: years.length,
