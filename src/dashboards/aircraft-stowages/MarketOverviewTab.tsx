/**
 * Market Overview Tab — self-contained for Aircraft Stowages dashboard.
 */
...
export function MarketOverviewTab({ marketData, selectedYear, onNavigateToTab }: MarketOverviewTabProps) {
  ...
  const handleSliceClick = (segmentName: string, segmentData: YearlyData[], color: string, donutType: TabType) => {
    ...
    switch (donutType) {
      ...
      case "stowageType": relatedSegments = { title: "By Region", data: marketData.region }; break;
    }
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <DistributionDonutsRow
          ...
          stowageTypeData={marketData.stowageType}
          year={selectedYear}
