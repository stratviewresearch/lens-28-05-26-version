/**
 * DASHBOARD CONFIGURATION — Aircraft PSU Market
 */

import { BarChart3, Users, Plane, Globe, Package, Layers } from "lucide-react";
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/27",
  title: "Global Aircraft PSU Market",
  ...
  tabs: [
    ...
    { id: "component", label: "Component Type", icon: Layers },
  ] as TabConfig[],
  ...
  segmentMapping: {
    ...
    component:  { dataKey: "application",        title: "Component Type" },
  } as Record<string, { dataKey: string; title: string }>,

  routePath: "/dashboard/aircraft-psu",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-interiors",
    dashboardId: "aircraft-psu",
    dashboardName: "Aircraft PSU Market",
    purchased: true,
