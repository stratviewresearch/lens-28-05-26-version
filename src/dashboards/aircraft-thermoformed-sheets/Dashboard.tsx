/**
 * Main Dashboard Page — Aircraft Thermoformed Sheets Market. Self-contained.
 */
...
const AircraftThermoformedSheetsDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.application, title: "Application Type" };
...
export default AircraftThermoformedSheetsDashboard;
