/**
 * Main Dashboard Page — Aircraft Water/Waste Water Market. Self-contained.
 */
...
const AircraftWasteWaterDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.endUser, title: "End-User Type" };
...
export default AircraftWasteWaterDashboard;
