/**
 * Market Overview Tab — self-contained for Aircraft Water/Waste Water dashboard.
 */
...
export function MarketOverviewTab({ marketData, selectedYear, onNavigateToTab }: MarketOverviewTabProps) {
  ...
  const handleSliceClick = (segmentName: string, segmentData: YearlyData[], color: string, donutType: TabType) => {
    ...
    switch (donutType) {
      ...
      case "waterSystem": relatedSegments = { title: "By Region", data: marketData.region }; break;
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <DistributionDonutsRow
          ...
          waterSystemData={marketData.waterSystemType}
          equipmentData={marketData.furnishedEquipment}
          componentData={marketData.componentType}
          year={selectedYear}
