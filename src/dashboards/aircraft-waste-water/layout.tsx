/**
 * Layout components for Aircraft Water/Waste Water dashboard.
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex gap-2">{[1, 2, 3, 4, 5, 6].map((i) => <Skeleton key={i} className="h-10 w-24" />)}</div>
...
interface YearSelectorProps { value: number; onChange: (year: number) => void; label?: string; years?: number[]; }
...
interface MainNavigationProps { value: TabType; onChange: (value: TabType) => void; selectedYear?: number; onYearChange?: (year: number) => void; showYearSelector?: boolean; tabs: TabConfig[]; years?: number[]; }
