/**
 * DASHBOARD CONFIGURATION — Aircraft Safety MRO Market
 *
 * Slot remapping:
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/51",
  title: "Aircraft Safety MRO",
  subtitle: "Global Market Research Dashboard",
  defaultYear: new Date().getFullYear() - 1,
  useMillions: true, // values in US$ Million

  footerText: "Aircraft Safety MRO Market Research Report",
  ...
  routePath: "/dashboard/aircraft-safety-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "aircraft-safety-mro",
    dashboardName: "Aircraft Safety MRO",
    purchased: true,
