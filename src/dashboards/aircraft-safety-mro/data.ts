/**
 * Types, data fetching hook, and utility hooks for Aircraft Safety MRO dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Aircraft Safety MRO", "Safety MRO", "MRO Market"]);
  ...
  console.log("[Aircraft Safety MRO parser] Parsed:", {
    years: years.length,
