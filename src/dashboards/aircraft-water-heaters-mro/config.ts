/**
 * DASHBOARD CONFIGURATION — Aircraft Water Heaters MRO Market
 *
 * Slot remapping:
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/54",
  title: "Aircraft Water Heaters MRO",
  subtitle: "Global Market Research Dashboard",
  defaultYear: new Date().getFullYear() - 1,
  useMillions: true, // values in US$ Million

  footerText: "Aircraft Water Heaters MRO Market Research Report",
  ...
  routePath: "/dashboard/aircraft-water-heaters-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "aircraft-water-heaters-mro",
    dashboardName: "Aircraft Water Heaters MRO",
    purchased: true,
