/**
 * Types, data fetching hook, and utility hooks for Avionics MRO dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Avionics MRO", "Safety MRO", "MRO Market"]);
  ...
  console.log("[Avionics MRO parser] Parsed:", {
    years: years.length,
