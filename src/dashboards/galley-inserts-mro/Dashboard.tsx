/**
 * Main Dashboard Page — Galley Inserts MRO (self-contained).
 */
...
const GalleyInsertsMRODashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.aircraftType, title: "Platform Type" };
...
export default GalleyInsertsMRODashboard;
