/**
 * ============================================================
 * DASHBOARD CONFIGURATION — Aircraft IFEC Market
 * ============================================================
 */

import { BarChart3, Users, Plane, Globe, Layers, Monitor } from "lucide-react";
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/23",
  title: "Global Aircraft IFEC Market",
  ...
  tabs: [
    ...
    { id: "application", label: "Product Type", icon: Monitor },
  ...
  routePath: "/dashboard/aircraft-ifec",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-interiors",
    dashboardId: "aircraft-ifec",
    dashboardName: "Aircraft IFEC Market",
    purchased: true,
