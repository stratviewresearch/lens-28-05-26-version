...
export function DistributionDonutsRow({ endUserData, aircraftData, regionData, applicationData, equipmentData, processTypeData, materialTypeData, year, onDonutClick, onSliceClick, endUserLabel = "End User", equipmentLabel = "Equipment", processTypeLabel = "Process Type", applicationLabel = "Application", materialTypeLabel = "Material Type", isVolume = false }: DistributionDonutsRowProps) {
  ...
  const donutCount = (hasEndUser ? 1 : 0) + (hasAircraft ? 1 : 0) + 1 + (hasApplication ? 1 : 0) + 1 + (hasProcessType ? 1 : 0) + (hasMaterialType ? 1 : 0);
  ...
  return (
    <div className={`grid ${gridCols} gap-4`}>
      {hasEndUser && <MiniDonut data={endUserData} year={year} title={endUserLabel} tabType="endUser" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.1} isVolume={isVolume} />}
      {hasAircraft && <MiniDonut data={aircraftData} year={year} title="Aircraft Type" tabType="aircraft" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.15} isVolume={isVolume} />}
      <MiniDonut data={regionData} year={year} title="Region" tabType="region" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.2} isVolume={isVolume} />
      {hasApplication && <MiniDonut data={applicationData} year={year} title={applicationLabel} tabType="application" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.25} isVolume={isVolume} />}
      <MiniDonut data={equipmentData} year={year} title={equipmentLabel} tabType="equipment" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.3} isVolume={isVolume} />
      {hasProcessType && <MiniDonut data={processTypeData} year={year} title={processTypeLabel} tabType="process" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.35} isVolume={isVolume} />}
      {hasMaterialType && <MiniDonut data={materialTypeData} year={year} title={materialTypeLabel} tabType="material" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.4} isVolume={isVolume} />}
    </div>
  );
}
