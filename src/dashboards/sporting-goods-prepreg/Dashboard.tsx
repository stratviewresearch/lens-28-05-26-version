/**
 * Main Dashboard Page — Sporting Goods Prepreg Market
 */
...
const SportingGoodsPrepregDashboard = () => {
  ...
  const getSegmentInfo = () => {
    ...
    if (!mapping) return { data: marketData.furnishedEquipment, title: "Fiber Type" };
...
export default SportingGoodsPrepregDashboard;
