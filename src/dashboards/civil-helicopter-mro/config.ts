/**
 * DASHBOARD CONFIGURATION — Civil Helicopter MRO Market
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/42",
  title: "Civil Helicopter MRO Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025,
  useMillions: false,

  footerText: "Civil Helicopter MRO Market Research Report",
  ...
  tabs: [
    ...
    { id: "aircraft", label: "Helicopter Type", icon: Plane },
  ...
  segmentMapping: {
    ...
    aircraft:   { dataKey: "aircraftType", title: "Helicopter Type" },
    region:     { dataKey: "region",       title: "Region" },
  } as Record<string, { dataKey: string; title: string }>,

  routePath: "/dashboard/civil-helicopter-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "civil-helicopter-mro",
    dashboardName: "Civil Helicopter MRO Market",
    purchased: true,
