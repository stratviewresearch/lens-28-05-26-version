...
import { ArrowUp, DollarSign, Hash } from "lucide-react";
...
export function MainNavigation({ value, onChange, selectedYear, onYearChange, showYearSelector = false, tabs, years, children }: MainNavigationProps) {
  return (
