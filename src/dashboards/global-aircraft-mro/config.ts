/**
 * DASHBOARD CONFIGURATION — Global Aircraft MRO Market
 */
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/39",
  title: "Global Aircraft MRO Market",
  subtitle: "Global Market Research Dashboard",
  defaultYear: 2025,
  useMillions: false, // values are in US$ Billion

  footerText: "Aircraft MRO Market Research Report",
  ...
  routePath: "/dashboard/global-aircraft-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "global-aircraft-mro",
    dashboardName: "Global Aircraft MRO Market",
    purchased: true,
