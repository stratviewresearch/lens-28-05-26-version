/**
 * Types, data fetching hook, and utility hooks for Aircraft Power Generation MRO dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Aircraft Power Generation MRO", "Power Generation MRO", "MRO Market"]);
  ...
  console.log("[Aircraft Power Generation MRO parser] Parsed:", {
    years: years.length,
