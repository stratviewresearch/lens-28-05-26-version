/**
 * DASHBOARD CONFIGURATION — Aircraft Power Generation MRO Market
 *
 * Slot remapping:
...
export const config = {
  dataUrl: "https://lens.stratviewresearch.com/reactadmin/web/proxy/50",
  title: "Aircraft Power Generation MRO",
  subtitle: "Global Market Research Dashboard",
  defaultYear: new Date().getFullYear() - 1,
  useMillions: true, // values in US$ Million

  footerText: "Aircraft Power Generation MRO Market Research Report",
  ...
  routePath: "/dashboard/aircraft-power-generation-mro",
  catalog: {
    categoryId: "aerospace-defense",
    datasetId: "aircraft-mro",
    dashboardId: "aircraft-power-generation-mro",
    dashboardName: "Aircraft Power Generation MRO",
    purchased: true,
