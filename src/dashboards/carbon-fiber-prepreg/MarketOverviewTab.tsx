/**
 * Market Overview Tab — Carbon Fiber Prepreg Market dashboard.
 */
...
import { MarketData, calculateCAGR, YearlyData, useDrillDown } from "./data";
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <DistributionDonutsRow
          ...
          prepregTypeData={marketData.application}
