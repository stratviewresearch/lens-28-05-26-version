...
export function DistributionDonutsRow({ endUserData, aircraftData, regionData, applicationData, equipmentData, processTypeData, materialTypeData, year, onDonutClick, onSliceClick, endUserLabel = "End User", equipmentLabel = "Equipment", processTypeLabel = "Process Type", applicationLabel = "Application", materialTypeLabel = "Material Type", isVolume = false }: DistributionDonutsRowProps) {
  ...
  return (
    <div className={`grid ${gridCols} gap-4`}>
      <MiniDonut data={endUserData} year={year} title={endUserLabel} tabType="endUser" onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.1} isVolume={isVolume} />
      {hasAircraft && <MiniDonut data={aircraftData} year={year} title="Aircraft Type" tabType={"endUser" as TabType} onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.15} isVolume={isVolume} />}
      ...
      {hasMaterialType && <MiniDonut data={materialTypeData} year={year} title={materialTypeLabel} tabType={"endUser" as TabType} onClick={onDonutClick} onSliceClick={onSliceClick} delay={0.4} isVolume={isVolume} />}
    </div>
  );
}
