/**
 * Types, data fetching hook, and utility hooks for Aircraft Interiors Injection Molding & Others dashboard.
...
function buildMarketData(sections: ParsedSection[]): MarketData {
  ...
  const totalSection = findSection(["Injection Molding", "Aircraft Interiors Injection"]);
  ...
  console.log("[Injection Molding parser] Parsed:", {
    years: years.length,
